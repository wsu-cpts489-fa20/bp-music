...
import CreateFanAccountDialog from './CreateFanAccountDialog.js';
...
class CreateEditAccountDialog extends React.Component {
    ...
    <div className="modal-dialog modal-lg"></div>
        ...
        {this.state.confirmDelete ? 
         ...
         /> : null}
         {this.state.showFanDialog ?
            <CreateFanAccountDialog
                    handleGenre={this.handleGenres()}
                    handleArtist={this.handleArtists()}
                    handleVenue={this.handleVenues()} /> : null}
    </div>
    );
}
handleAccountType = () => {
    this.setState({cre: true});
